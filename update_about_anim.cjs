...
const oldAbout = `const About = ({ setPage }) => {
    return (
...
const newAbout = `const About = ({ setPage }) => {
...
content = content.replace(oldAbout.replace(/\n/g, '\r\n'), newAbout.replace(/\n/g, '\r\n'));

fs.writeFileSync('src/App.jsx', content, 'utf8');
console.log('App.jsx About component animation updated!');
